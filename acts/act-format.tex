...
%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[left=2.5in,right=2.5in,bottom=1in]{geometry}
...
\setromanfont{New Century Schoolbook LT Std}
\newfontface\goudy{Goudy Text MT Std}
...
\bodo Begun and held at the City of Washington on \printcongressdow,
